            ...
            <div class="row">
                ...
                <div class="col-lg-15" >
                   <p class="navbar-text pull-left">
					...
					<a href="#" class="navbar-link" style="color:<?php echo $configuser['hiper'];?>;"><span class="fa fa-group fa-fw" style="color:<?php echo $configuser['icon']?>;"></span>ON/OFF ></a>
					</p>	   
                </div>
                </div>
            </div>
			 <div class="row">
                <div class="col-lg-15">
				<h2><center>ON/OFF</center></h2><br>
				<div class="col-lg-8 col-md-offset-2">
                 <div class="row">
					<form class='form-horizontal' role='form'  method='post' action='php/change.php'>
