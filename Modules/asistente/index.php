...
?>
        <div id="page-wrapper" style="background-color:<?php echo $configuser['bg1']?>;">
            <div class="row">
                <div class="col-lg-15">
                    <h1 class="page-header">Aplicación: <?php echo utf8_encode($datosmudulo['name']);?></h1>
                </div>
            </div>
				...
				?>
                 <div id="freewall" class="free-wall">
				  <div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='activar.php' title='Activa o desactiva el asistente'>
						<center><IMG SRC='icon.png' class='img-responsive' width='80px'>
						<h2>ON/OFF</h2><br></center>
						</a>
						</div>
						</div>
				<div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='info.php' title=' que es?'>
						<center><IMG SRC='icon.png' class='img-responsive' width='80px'>
						<h2>Información</h2><br></center>
						</a>
						</div>
						</div>
