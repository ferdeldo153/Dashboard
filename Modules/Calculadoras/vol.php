...
include("../../resources/theme/Module/".$configuser['theme']);
	echo headopen1("Convertidor de Volumenes");
        ...
        <div id="page-wrapper" style="background-color:<?php echo $configuser['bg1']?>;">
                ...
                <div class="col-lg-15" >
                   <p class="navbar-text pull-left">
					...
					<a href="#" class="navbar-link" style="color:<?php echo $configuser['hiper'];?>;"><span class="fa fa-group fa-fw" style="color:<?php echo $configuser['icon']?>;"></span>Volumenes ></a>
					</p>	   
                </div>
                </div>
            </div>
                   ...
                   <div style="background:<?php echo $configuser['bg1']?>;">                     
                        ...
                        <div class=" selectContainer">
                            <select class="form-control" name="size" id="fuente">
                                ...
                                <option value="MT3">MT3 - METRO CUBICO </option>
                                <option value="DM3">DM3 - LITRO</option>
                                <option value="FT3">FT3 - PIE CUBICO</option>
                                <option value="GAL">GAL - GALON</option>
                                <option value="BBL">BBL - BARRIL DE PETROLEO</option>
