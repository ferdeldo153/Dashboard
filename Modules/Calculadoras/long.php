...
include("../../resources/theme/Module/".$configuser['theme']);
	echo headopen1("Convertidor de Longitudes");
...
?>	
        <div id="page-wrapper" style="background-color:<?php echo $configuser['bg1']?>;">
                ...
                <div class="col-lg-15" >
                   <p class="navbar-text pull-left">
					...
					<a href="#" class="navbar-link" style="color:<?php echo $configuser['hiper'];?>;"><span class="fa fa-group fa-fw" style="color:<?php echo $configuser['icon']?>;"></span>Longitudes ></a>
					</p>	   
                </div>
                </div>
            </div>
        ...
        <div class=" selectContainer">
            <select class="form-control" name="size" id="fuente">
                  ...
                  <option value="HM">HM - Hectometro</option>
                  <option value="DAM">DAM - Decametro</option>
                   <option value="MT">MT - Metro</option>
                  <option value="DM">DM - Decimetro</option>
                  <option value="CM">CM - Centimetro</option>
                 ...
                 <option value="MI">MI - MILLA</option>
