...
include("../../resources/theme/Module/".$configuser['theme']);
	echo headopen1("Calculadora de Cuotas Mensuales Hipotecas");
        ...
        <script>
            ...
            function converter (Mtotal,Interes,Plazo,TipoPlazo ){
              ...
              if(TipoPlazo=="AN"){
                ...
                Pt=Math.pow((1+Interes), Plazo);
                
                resultado=Mtotal*((Pt*Interes)/(Pt-1));
                
                document.getElementById("total").innerHTML ="<center>El Resultado es :</center><br><h3>"+resultado.toFixed(4)+"</h3> <br>";    
            }
        </script>
<?php
	echo headclose1();
        ...
        <div id="page-wrapper" style="background-color:<?php echo $configuser['bg1']?>;">
                ...
                <div class="col-lg-15" >
                   <p class="navbar-text pull-left">
					...
					<a href="#" class="navbar-link" style="color:<?php echo $configuser['hiper'];?>;"><span class="fa fa-group fa-fw" style="color:<?php echo $configuser['icon']?>;"></span>Hipoteca ></a>
					</p>	   
                </div>
                </div>
            </div>
                ...
                <div class="col-lg-15" style="background: #fff;">
                   <div style="background:<?php echo $configuser['bg1']?>;">                     
                    ...
                    <div id="total"> 
							...
							<hr>
                        <center>  <label for="usr">Inserte monto Total del prestamo:</label> </center>
                        <input type="text" style="text-align:center" class="form-control" placeholder="Monto total en pesos - MXN" id="Mtotal">
                        <br>
                        <center>  <label for="usr">Inserte la tasa de interes % :</label> </center>
                        <input type="text"  style="text-align:center" class="form-control" placeholder="Tasa de interes - solo numero" id="Interes">
                        <br>
