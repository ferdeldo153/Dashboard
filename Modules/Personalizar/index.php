				...
				?>
                 <div id="freewall" class="free-wall">
				   <div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='theme.php' title='Configurar dashboard'>
						<center><IMG SRC='icon/icon.png' class='img-responsive' width='80px'>
						<h2>Elega un tema</h2><br></center>
						</a>
						</div>
						</div>
				  ...
				  <div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='changetheme.php' title='Agrege nuevos usuarios'>
						<center><IMG SRC='icon/icon.png' class='img-responsive' width='80px'>
						<h2>Elegir colores</h2><br></center>
						</a>
						</div>
						</div>
					 ...
					 <div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='changedash.php' title='Configurar dashboard'>
						<center><IMG SRC='icon/icon.png' class='img-responsive' width='80px'>
						<h2>Configurar dashboard</h2><br></center>
						</a>
						</div>
						</div>
