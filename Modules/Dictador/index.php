      ...
      if(annyang){
        var commands = {
          '*valor':function(valor){
            $("#parametro").val( $("#parametro").val()+" "+valor);
          }
        };
...
?>
        ...
        <div id="page-wrapper" style="background-color:<?php echo $configuser['bg1']?>;">
            <div class="row">
                <div class="col-lg-15">
                    <h1 class="page-header"><?php echo $datosmudulo['name'];?></h1>
                </div>
            </div>
			 <div class="row">
                <div class="col-lg-15">
           <textarea rows="20" cols="50" x-webkit-speech   id="parametro" name="parametro" class="form-control"  placeholder="Dictado"></textarea>
                </div>
            </div>
        </div>
<?php
