				...
				?>
                 <div id="freewall" class="free-wall">
				  <div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='addnote.php' title='Cree una nota'>
						<center><IMG SRC='icon/add.png' class='img-responsive' width='80px'>
						<h2>Agregar Nota</h2><br> </center>
						</a>
						</div>
						</div>
				<div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='viewnotes.php' title='vea sus ultimas notas'>
						<center><IMG SRC='icon/ver.png' class='img-responsive' width='80px'>
						<h2>Ver notas</h2><br></center>
						</a>
						</div>
						</div>
					<div class='brick size21' style='background:<?php echo $color;?>'>
						<div class='cover'>
						<a href='findnotes.php' title='Busque notas'>
						<center><IMG SRC='icon/ver.png' class='img-responsive' width='80px'>
						<h2>Buscar notas</h2><br></center>
						</a>
						</div>
						</div>
